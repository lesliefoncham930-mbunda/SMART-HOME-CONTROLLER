                    ...
                    controls=[
                        ...
                        ft.Row(
                            ...
                            controls=[
                                ...
                                ft.FilledButton("Turn ON" if not light_on else "Turn OFF", on_click=toggle_light)
                            ]
                        )
                    ]
                )
                    ...
                    controls=[
                        ...
                        ft.Row(
                            ...
                            controls=[
                                ...
                                ft.FilledButton("Unlock" if door_locked else "Lock", on_click=toggle_door)
                            ]
                        )
                    ]
                )
            ...
            page.views.append(
                ft.View(
                    ...
                    controls=[
                        ...
                        ft.Row([light_card, door_card], spacing=20, alignment=ft.MainAxisAlignment.CENTER),
                        ft.Text("Slider controlled devices", size=20, weight="bold"),
                        ft.Row([thermo_card, fan_card], spacing=20, alignment=ft.MainAxisAlignment.CENTER)
                    ]
                )
            )
            ...
            page.views.append(
                ft.View(
                    ...
                    controls=[
                        ...
                        ft.Container(padding=10, bgcolor=ft.Colors.WHITE, content=table,
                                     border=ft.border.all(1, ft.Colors.GREY_300))
                    ]
                )
            )
